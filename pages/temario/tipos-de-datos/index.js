...
export default function TiposDeDatos() {
  return (
    <ModuleBlock
      ComponentToRender={<TemarioTiposDeDatos />}
      back={{
        title: "Variables",
      ...
      next={{
        ...
        link: "/temario/comentarios-en-codigo/",
      }}
    ></ModuleBlock>
  );
}

function TemarioTiposDeDatos() {
  return (
    <div className={styles.container}>
      <article>
        <h2 className={styles.title_block}>Tipos de datos</h2>
        <p>
